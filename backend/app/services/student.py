...
async def submit_student_test(db, student_id, test_id, answers):
    ...
    student_notification = {
        ...
        "redirect_url": "/student-panel/tests",
        "meta": {"test_id": test_id_text, "attempt_id": attempt_id, "score": score, "total": max_score, "redirect_url": "/student-panel/tests", "entity_type": "assignment"},
        "read": False,
        "created_at": now,
        "updated_at": now,
    }
    ...
    for admin_id in admin_ids:
        notification = {
            ...
            "type": "assessment",
            "entity_type": "assignment",
            "redirect_url": "/admin/weekly-tests",
            "meta": {"test_id": test_id_text, "attempt_id": attempt_id, "student_id": student_id_text, "redirect_url": "/admin/weekly-tests", "entity_type": "assignment"},
            "read": False,
            "created_at": now,
            "updated_at": now,
        }
    ...
    if created_by:
        ...
        if creator_role == "instructor":
            instructor_notification = {
                ...
                "type": "assessment",
                "entity_type": "assignment",
                "redirect_url": "/instructor/weekly-tests",
                "meta": {"test_id": test_id_text, "attempt_id": attempt_id, "student_id": student_id_text, "redirect_url": "/instructor/weekly-tests", "entity_type": "assignment"},
                "read": False,
                "created_at": now,
                "updated_at": now,
            }
